...
Actual source code for this part of tutorial available [on github](https://github.com/vbo/node-webkit-mp-game-template/tree/minimal_toolset). I have just implemented a "Hello Triangle" graphics but we'll make a real render later on this tutorial. Stay in tune! UPD: part two is [online](__ROOT__building-multiplayer-game-nodejs-node-webkit-tiles-sprites/).
